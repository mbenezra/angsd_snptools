...
angsd/angsd -vcf-GL prob2vcf/10indv.out.recode.vcf.zip -doSaf 5 -fai hg19/hg19.fa.gz.fai -anc hg19anc/chimpHg19.fa.gz -nind 10 -doMajorMinor 1 -out sfs_snptools/snptools.ceu
