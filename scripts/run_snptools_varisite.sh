...
for number in {1..22}; do echo /willerslev/software/snptools/varisite -v hapmap/hapmap_3.3.CEU.chr$number.hg19.vcf ebds.list $number hg19/chr$number.hg19.fa; done > varisite.txt
