...
do
	gunzip -c geno_sam_uni/sam.uni.chr$number.geno.gz > geno_sam_uni/sam.uni.chr$number.geno
	...
	gzip -c geno_sam_uni/sam.uni.chr$number.gt > geno_sam_uni/sam.uni.chr$number.gt.gz
	...
	gzip -c geno_sam_uni/sam.uni.chr$number.gl > geno_sam_uni/sam.uni.chr$number.gl.gz
	cut -f1,2,3,4 geno_sam_uni/sam.uni.chr$number.geno > geno_sam_uni/sam.uni.chr$number.mm
	gzip -c geno_sam_uni/sam.uni.chr$number.mm > geno_sam_uni/sam.uni.chr$number.mm.gz
done

cat geno_sam_uni/sam.uni.chr{1..22}.gt > geno_sam_uni/sam.uni.hg19.gt
gzip -c geno_sam_uni/sam.uni.hg19.gt > geno_sam_uni/sam.uni.hg19.gt.gz
cat geno_sam_uni/sam.uni.chr{1..22}.gl > geno_sam_uni/sam.uni.hg19.gl
gzip -c geno_sam_uni/sam.uni.hg19.gl > geno_sam_uni/sam.uni.hg19.gl.gz
cat geno_sam_uni/sam.uni.chr{1..22}.mm > geno_sam_uni/sam.uni.hg19.mm
gzip -c geno_sam_uni/sam.uni.hg19.mm > geno_sam_uni/sam.uni.hg19.mm.gz
