...
In this work we seek to compare the SNPTools genotype likelihood model to that of SAMTOOLS and GATK under low-depth data conditions. Because the true genotype likelihoods are unknown to us we judge the accuracy of genotype likelihoods by calling genotypes and comparing to true genotypes according to the hapmap. We perform a reciever operating curve analysis based on the genotype calls and compare the results.
